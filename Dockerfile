...
RUN apt-get update -y && \
    DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends  git openssh-client python3 python-is-python3 python3-venv vim wget && \
